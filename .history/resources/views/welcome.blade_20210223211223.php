        ...
        <div class="container position-relative py-5">
            <div class="row py-5">
                <div class="col-md-12 text-center">
                    <h2 class="text-white mb-4">Testimoni Adu.co</h2>
                </div>
                <div class="slider" id="testimoni-slider">
                    <div class="px-4">
                        <div class="card w-100">
                            <div class="card-body">
                                <h5 class="card-title mb-2">Saputro Adi</h5>
                                <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Similique doloribus consectetur labore?</p>
                            </div>
                        </div>
                    </div>
                    <div class="px-4">
                        <div class="card w-100">
                            <div class="card-body">
                                <h5 class="card-title mb-2">Adi Saputro Cahyo</h5>
                                <p class="card-text">Lorem ipsum, dolor sit amet consectetur adipisicing elit. In, esse.</p>
                            </div>
                        </div>
                    </div>
                    <div class="px-4">
                        <div class="card w-100">
                            <div class="card-body">
                                <h5 class="card-title mb-2">Saputro Cahyo Adi</h5>
                                <p class="card-text">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Quis dignissimos consequatur eos veniam, animi iusto enim itaque obcaecati minus sequi?</p>
                            </div>
                        </div>
                    </div>
                    <div class="px-4">
