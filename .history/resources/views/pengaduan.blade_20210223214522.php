                    ...
                    <div class="card bg-white rounded-3 shadow py-5 px-4">
                        ...
                        <form action="{{ route('pengaduan.post') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group my-2">
                                ...
                                <input type="file" class="form-control" id="picture" aria-describedby="picture-feedback" name="picture" id="picture">
                                <small id="picture-feedback">Optoinal</small>
                            </div>
                            <div class="form-group my-2">
                            ...
                            <div class="form-group my-2">
                                ...
                                <textarea type="text" rows="5" required aria-describedby="text-feedback" name="report" id="text" class="form-control" placeholder="Isi Laporan dis sini"></textarea>
