                ...
                <div class="slider" id="testimoni-slider">
                    <div class="px-4">
                        <div class="card w-100">
                            <div class="card-body">
                                ...
                                <h6 class="card-subtitle mb-2 text-muted">Saputro Adi</h6>
                    ...
                    <div class="px-4">
                        <div class="card w-100">
                            <div class="card-body">
                                <h5 class="card-title">Card title</h5>
                                <h6 class="card-subtitle mb-2 text-muted">Adi Saputro Cahyo</h6>
                                <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                                <a href="#" class="card-link">Card link</a>
                                <a href="#" class="card-link">Another link</a>
                            </div>
                    ...
                    <div class="px-4">
                        <div class="card w-100">
                            <div class="card-body">
                                <h5 class="card-title">Card title</h5>
                                <h6 class="card-subtitle mb-2 text-muted">Saputro Cahyo Adi</h6>
                                <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                                <a href="#" class="card-link">Card link</a>
                                <a href="#" class="card-link">Another link</a>
                            </div>
                    ...
                    <div class="px-4">
                        <div class="card w-100">
                            <div class="card-body">
                                ...
                                <h6 class="card-subtitle mb-2 text-muted">Cahyo Adi Saputro</h6>
                                <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                            </div>
                        </div>
                    </div>
