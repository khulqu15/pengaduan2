              ...
              <div class="card-body">
                ...
                <form action="{{ route('loginLogic') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="password" id="password" type="password" class="form-control" placeholder="Your password here" aria-describedby="helpId">
                        <small id="helpId" class="text-muted">Required</small>
                    </div>
                    <div class="form-group">
                        <label for="repassword">Ulangi Password</label>
                        <input type="text" name="repassword" id="repassword" type="password" class="form-control" placeholder="Your repassword here" aria-describedby="helpId">
                        <small id="helpId" class="text-muted">Required</small>
                    </div>
